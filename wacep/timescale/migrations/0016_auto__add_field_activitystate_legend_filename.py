...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityState.legend_filename'
        db.add_column('timescale_activitystate', 'legend_filename',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityState.legend_filename'
        db.delete_column('timescale_activitystate', 'legend_filename')
