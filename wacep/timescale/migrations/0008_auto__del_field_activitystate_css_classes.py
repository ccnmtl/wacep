...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivityState.css_classes'
        db.delete_column('timescale_activitystate', 'css_classes')


    def backwards(self, orm):
        # Adding field 'ActivityState.css_classes'
        db.add_column('timescale_activitystate', 'css_classes',
