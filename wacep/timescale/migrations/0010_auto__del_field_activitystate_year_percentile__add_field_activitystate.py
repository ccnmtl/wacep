...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ActivityState.year'
        db.add_column('timescale_activitystate', 'year',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'ActivityState.overall_percentile'
        db.add_column('timescale_activitystate', 'overall_percentile',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'ActivityState.overall_sum'
        db.add_column('timescale_activitystate', 'overall_sum',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ActivityState.year'
        db.delete_column('timescale_activitystate', 'year')

        # Deleting field 'ActivityState.overall_percentile'
        db.delete_column('timescale_activitystate', 'overall_percentile')

        # Deleting field 'ActivityState.overall_sum'
        db.delete_column('timescale_activitystate', 'overall_sum')
