...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityState.show_left_side'
        db.add_column('timescale_activitystate', 'show_left_side',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActivityState.show_year_details'
        db.add_column('timescale_activitystate', 'show_year_details',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityState.show_left_side'
        db.delete_column('timescale_activitystate', 'show_left_side')

        # Deleting field 'ActivityState.show_year_details'
        db.delete_column('timescale_activitystate', 'show_year_details')
