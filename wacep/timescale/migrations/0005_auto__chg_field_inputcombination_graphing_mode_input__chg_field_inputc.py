...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InputCombination.graphing_mode_input'
        db.alter_column('timescale_inputcombination', 'graphing_mode_input_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timescale.GraphingModeInput'], null=True))

        # Changing field 'InputCombination.year_input'
        db.alter_column('timescale_inputcombination', 'year_input_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timescale.YearInput'], null=True))

        # Changing field 'InputCombination.season_input'
        db.alter_column('timescale_inputcombination', 'season_input_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timescale.SeasonInput'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'InputCombination.graphing_mode_input'
        db.alter_column('timescale_inputcombination', 'graphing_mode_input_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['timescale.GraphingModeInput']))

        # Changing field 'InputCombination.year_input'
        db.alter_column('timescale_inputcombination', 'year_input_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['timescale.YearInput']))

        # Changing field 'InputCombination.season_input'
        db.alter_column('timescale_inputcombination', 'season_input_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['timescale.SeasonInput']))
    ...
    models = {
        ...
        'timescale.inputcombination': {
            ...
            'activity_state': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timescale.ActivityState']", 'unique': "'True'", 'null': 'True'}),
            'graphing_mode_input': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timescale.GraphingModeInput']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'season_input': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timescale.SeasonInput']", 'null': 'True'}),
            'year_input': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timescale.YearInput']", 'null': 'True'})
        },
