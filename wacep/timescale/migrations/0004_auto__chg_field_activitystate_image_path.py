...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityState.image_path'
        db.alter_column('timescale_activitystate', 'image_path', self.gf('django.db.models.fields.FilePathField')(max_length=100, path='/var/www/images_for_timescale_tool', null=True))

    def backwards(self, orm):

        # Changing field 'ActivityState.image_path'
        db.alter_column('timescale_activitystate', 'image_path', self.gf('django.db.models.fields.FilePathField')(default=None, path='/var/www/images_for_timescale_tool', max_length=100))
