...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityState.year_trend'
        db.add_column('timescale_activitystate', 'year_trend',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityState.year_trend'
        db.delete_column('timescale_activitystate', 'year_trend')
