...
INSERT INTO figure_viewer_activitystate (id, name, image_filename, order_rank, title, text, climate_impact, graph_title, colorbar_filename, source) VALUES (0, 'Default GC', '', 0, 'Title', '', '', '', '', '');
...
INSERT INTO figure_viewer_activitystate (id, name, image_filename, order_rank, title, text, climate_impact, graph_title, colorbar_filename, source) VALUES (83, 'Default NV', '', 60, 'Default NV', '', '', '', '', '');
INSERT INTO figure_viewer_activitystate (id, name, image_filename, order_rank, title, text, climate_impact, graph_title, colorbar_filename, source) VALUES (84, 'Default TC', '', 70, 'Default TC', '', '', '', '', '');
...
SELECT pg_catalog.setval('figure_viewer_activitystate_id_seq', 84, true);
...
SELECT pg_catalog.setval('figure_viewer_animationinput_id_seq', 3, true);
...
SELECT pg_catalog.setval('figure_viewer_climatevariableinput_id_seq', 5, true);
...
SELECT pg_catalog.setval('figure_viewer_graphingmodeinput_id_seq', 8, true);
...
--
-- Data for Name: figure_viewer_yearinput; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO figure_viewer_yearinput (id, name, order_rank) VALUES (1, '1982', 0);
INSERT INTO figure_viewer_yearinput (id, name, order_rank) VALUES (2, '1986', 1);
INSERT INTO figure_viewer_yearinput (id, name, order_rank) VALUES (3, '1997', 2);
INSERT INTO figure_viewer_yearinput (id, name, order_rank) VALUES (4, '1988', 8);
INSERT INTO figure_viewer_yearinput (id, name, order_rank) VALUES (5, '1999', 9);
INSERT INTO figure_viewer_yearinput (id, name, order_rank) VALUES (6, '2010', 10);
...
INSERT INTO figure_viewer_inputcombination (id, season_input_id, climate_variable_input_id, animation_input_id, activity_state_id, topic_id, year_input_id, mode_of_variability_input_id, graphing_mode_input_id) VALUES (71, NULL, NULL, NULL, 83, 2, NULL, NULL, NULL);
INSERT INTO figure_viewer_inputcombination (id, season_input_id, climate_variable_input_id, animation_input_id, activity_state_id, topic_id, year_input_id, mode_of_variability_input_id, graphing_mode_input_id) VALUES (72, NULL, NULL, NULL, 84, 3, NULL, NULL, NULL);
...
INSERT INTO figure_viewer_inputcombination (id, season_input_id, climate_variable_input_id, animation_input_id, activity_state_id, topic_id, year_input_id, mode_of_variability_input_id, graphing_mode_input_id) VALUES (23, NULL, NULL, 2, 0, 1, NULL, NULL, NULL);
INSERT INTO figure_viewer_inputcombination (id, season_input_id, climate_variable_input_id, animation_input_id, activity_state_id, topic_id, year_input_id, mode_of_variability_input_id, graphing_mode_input_id) VALUES (24, NULL, NULL, NULL, 0, 1, NULL, NULL, NULL);
INSERT INTO figure_viewer_inputcombination (id, season_input_id, climate_variable_input_id, animation_input_id, activity_state_id, topic_id, year_input_id, mode_of_variability_input_id, graphing_mode_input_id) VALUES (43, NULL, NULL, 1, 56, 2, 1, 1, 4);
...
SELECT pg_catalog.setval('figure_viewer_inputcombination_id_seq', 72, true);
...
SELECT pg_catalog.setval('figure_viewer_seasoninput_id_seq', 6, true);


--
-- Name: figure_viewer_yearinput_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('figure_viewer_yearinput_id_seq', 7, true);
