...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('certificates_courseaccess', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='courses_accessed', to=orm['auth.User'])),
        ...
        # Adding unique constraint on 'Certificate', fields ['course', 'user']
        db.create_unique('certificates_certificate', ['course_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Certificate', fields ['course', 'user']
        db.delete_unique('certificates_certificate', ['course_id', 'user_id'])
    ...
    models = {
        ...
        'certificates.courseaccess': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'courses_accessed'", 'to': "orm['auth.User']"})
        },
