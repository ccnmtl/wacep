...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CertificateCourse.section'
        db.add_column('certificates_certificatecourse', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagetree.Section'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CertificateCourse.section'
        db.delete_column('certificates_certificatecourse', 'section_id')
