...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CertificateCourse.description'
        db.add_column('certificates_certificatecourse', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding unique constraint on 'CertificateCourse', fields ['section']
        db.create_unique('certificates_certificatecourse', ['section_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CertificateCourse', fields ['section']
        db.delete_unique('certificates_certificatecourse', ['section_id'])

        # Deleting field 'CertificateCourse.description'
        db.delete_column('certificates_certificatecourse', 'description')
